...
public class ZichanrukuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZichanrukuEntity zichanruku, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			zichanruku.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZichanrukuEntity zichanruku, HttpServletRequest request){
        EntityWrapper<ZichanrukuEntity> ew = new EntityWrapper<ZichanrukuEntity>();
		PageUtils page = zichanrukuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zichanruku), params), params));
        return R.ok().put("data", page);
    }
